...
extern double BChallengeLeaderboard[2][3][10];
extern double DChallengeLeaderboard[2][3][10];
extern int BLeaderboardPosition;
extern int DLeaderboardPosition;
extern int BLeaderboard;
extern int DLeaderboard;
extern int BSubLeaderboard;
extern int DSubLeaderboard;
extern int count;
extern int qtype1;
extern int qtype2;
extern int qtypec;
